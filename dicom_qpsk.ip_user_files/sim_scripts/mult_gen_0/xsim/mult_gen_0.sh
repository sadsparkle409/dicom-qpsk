...
#
# Script generated by Vivado on Thu Apr 02 23:11:09 +0800 2026
...
# script info
echo -e "mult_gen_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_15 -L mult_gen_v12_0_24 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mult_gen_0 xil_defaultlib.mult_gen_0 xil_defaultlib.glbl -log elaborate.log
}
...
Usage: mult_gen_0.sh [-rerun]\n\
Usage: mult_gen_0.sh [-reset_run]\n\
Usage: mult_gen_0.sh [-clean]\n\
