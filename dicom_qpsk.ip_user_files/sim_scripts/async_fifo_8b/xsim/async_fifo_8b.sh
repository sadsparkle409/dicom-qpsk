...
#
# Script generated by Vivado on Thu Apr 02 22:10:01 +0800 2026
...
#
# Usage        : async_fifo_8b.sh
#                async_fifo_8b.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                async_fifo_8b.sh [-rerun]
#                async_fifo_8b.sh [-reset_run]
#                async_fifo_8b.sh [-clean]
#                async_fifo_8b.sh [-reset_log]
#                async_fifo_8b.sh [-help]
#
...
export RDI_DATADIR="D:/tools/AMDDesignTools/2025.2/Vivado/data"
...
# script info
echo -e "async_fifo_8b.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./async_fifo_8b.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_14 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot async_fifo_8b xil_defaultlib.async_fifo_8b xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim async_fifo_8b -key {Behavioral:sim_1:Functional:async_fifo_8b} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/tools/AMDDesignTools/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb async_fifo_8b.wdb xsim.dir libdpi.so)
...
Usage: async_fifo_8b.sh [-step]\n\
Usage: async_fifo_8b.sh [-lib_map_path]\n\
Usage: async_fifo_8b.sh [-rerun]\n\
Usage: async_fifo_8b.sh [-reset_run]\n\
Usage: async_fifo_8b.sh [-clean]\n\
Usage: async_fifo_8b.sh [-reset_log]\n\
Usage: async_fifo_8b.sh [-keep_index]\n\
